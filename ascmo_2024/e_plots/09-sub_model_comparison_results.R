...
results_dir_gridMET = "./_results_sub_gridMET"
results_dir_Daymet = "./_results_sub_Daymet"
...
load(file.path(results_dir_gridMET, "std_perm_de_gridMET_era5_subtest.rda"))
tail(std_perm_de_gridMET_era5$tstats_global, 1)
std_perm_de_gridMET_era5$pvalue_global

load(file.path(results_dir_gridMET, "sp_test_de_gridMET_era5_subtest.rda"))
tail(sp_test_de_gridMET_era5$tstats_global, 1)
sp_test_de_gridMET_era5$pvalue_global

load(file.path(results_dir_Daymet, "std_perm_de_Daymet_era5_subtest.rda"))
tail(std_perm_de_Daymet_era5$tstats_global, 1)
std_perm_de_Daymet_era5$pvalue_global

load(file.path(results_dir_Daymet, "sp_test_de_Daymet_era5_subtest.rda"))
...
pdf(file.path(plot_dir, "de_test_plots_uncorrected_subtests.pdf"),
    height = 7, width = 7)
...
pdf(file.path(plot_dir, "de_test_plots_subtests.pdf"),
    height = 4, width = 7)
plot_test_objects(lon, lat, 
...
load(file.path(results_dir_gridMET, "sp_test_mean_gridMET_era5_subtest.rda"))
load(file.path(results_dir_Daymet, "sp_test_mean_Daymet_era5_subtest.rda"))
...
load(file.path(results_dir_gridMET, "sp_test_q50_gridMET_era5_subtest.rda"))
load(file.path(results_dir_Daymet, "sp_test_q50_Daymet_era5_subtest.rda"))
...
sp_test_q50_Daymet_era5_by$pvalues = p.adjust(sp_test_q50_Daymet_era5_by$pvalues,
                                              method = "BY")
pdf(file.path(plot_dir, "center_test_plots_subtests.pdf"),
    height = 7, width = 7)
plot_test_objects(lon, lat, 
...
load(file.path(results_dir_gridMET, "sp_test_sd_gridMET_era5_subtest.rda"))
load(file.path(results_dir_Daymet, "sp_test_sd_Daymet_era5_subtest.rda"))
...
load(file.path(results_dir_gridMET, "sp_test_iqr_gridMET_era5_subtest.rda"))
load(file.path(results_dir_Daymet, "sp_test_iqr_Daymet_era5_subtest.rda"))
...
pdf(file.path(plot_dir, "spread_test_plots_subtests.pdf"),
    height = 7, width = 7)
plot_test_objects(lon, lat, 
...
load(file.path(results_dir_gridMET, "sp_test_smooth_gridMET_era5_subtest.rda"))
load(file.path(results_dir_Daymet, "sp_test_smooth_Daymet_era5_subtest.rda"))
...
pdf(file.path(plot_dir, "smooth_test_plots_subtests.pdf"),
    height = 4, width = 7)
plot_test_objects(lon, lat, 
